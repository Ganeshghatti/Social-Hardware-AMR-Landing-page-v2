...
export default function HeroSection() {
  return (
    <section className="w-full bg-white">
      <div className="mx-auto flex flex-col md:flex-row border border-gray-200 justify-between px-6 md:px-12 lg:px-20 gap-5">
        <div className="md:w-1/2 md:border-r py-12 md:py-16 border-gray-200 h-full">
        ...
        <div className="md:w-1/2 flex items-center md:text-left py-12 md:py-16">
          <h1 className="max-w-2xl text-[#FF6600] font-normal text-3xl sm:text-4xl md:text-6xl leading-snug md:leading-tight">
