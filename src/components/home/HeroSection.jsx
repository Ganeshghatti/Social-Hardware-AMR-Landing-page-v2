  ...
  return (
    <section className="w-full bg-[#F5F5F5] font-geist">
      <div className="mx-auto  flex flex-col-reverse md:flex-row border-1 border-[#E5E5E5] justify-between px-6 sm:px-10 md:px-8 lg:px-10 gap-3 ">
        ...
        <div className="md:w-1/2  flex items-center justify-center md:justify-start text-center md:text-left py-2  md:py-6">
          <h1 className="text-[#FF6600] font-normal md:ml-2 2xl:ml-8 text-3xl sm:text-4xl md:text-6xl 2xl:text-6xl leading-snug md:leading-tight max-w-3xl">
